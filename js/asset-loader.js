const MAP={
 ...
 exterior:['../assets/base64/exterior-clay.webp.b64','image/webp'],
 ...
 lesson1:['../assets/base64/lesson1.mp4.b64','video/mp4'],lesson2:['../assets/base64/lesson2.mp4.b64','video/mp4']
};
const cache=new Map();
...
export async function hydrateAssets(root=document){const nodes=[...root.querySelectorAll('[data-asset]')];await Promise.all(nodes.map(async n=>{try{n.src=await assetUrl(n.dataset.asset);n.removeAttribute('data-asset-error')}catch(e){n.dataset.assetError=e.message;n.alt=(n.alt||'Asset')+' unavailable'}}));return nodes.length}
